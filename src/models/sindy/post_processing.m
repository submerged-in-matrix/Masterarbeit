% This script is used to stress-test SINDy identified equations analyzing the indicated physical system by the discovered equation
% and comparing those results to the expected physical system response suggested by the literature. Damping behavior, potential energy,
% stiffness characteristics were analyzed. 
...
figure;
plot(phase_voltage(:, 1), phase_voltage(:, 2)) 
line([0, 0], ylim, 'Color', 'k', 'LineStyle', '--'); % Vertical line
line(xlim, [0, 0], 'Color', 'k', 'LineStyle', '--'); % Horizontal line
